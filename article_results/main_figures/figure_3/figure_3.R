...
go <- readRDS("C:/Users/user/Documents/deepSIBA/preprocessing/data_preprocessing/utility/goterm_annotation.rds")
...
png(file="result_figure_1a.png",width=7,height=6,units = "in",res=300)
...
allq1 <- readRDS("C:/Users/user/Documents/deepSIBA/article_results/figure_extra_data/figure_3/q1_res_fig1.rds")
allq2 <- readRDS("C:/Users/user/Documents/deepSIBA/article_results/figure_extra_data/figure_3/q2_res_fig1.rds")

png(file="result_fig_1c.png",width=7,height=6,units = "in",res=300)
...
title("B", adj = 0)
abline(v=0.19,col="red",lwd = 2)
abline(h=0.2,col="red" ,lwd = 2)
legend("topleft", 
       legend = "Pearson's r = 0.469", 
       col = "black",
       pch = '',
       bty = "o", 
       pt.cex = 2, 
