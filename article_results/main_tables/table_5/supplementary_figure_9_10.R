library(tidyverse)
library(GO.db)
path_pa <- "C:/Users/user/Documents/deepSIBA/article_results/article_data/nes_compounds_all.rds"
path_gos <- "C:/Users/user/Documents/deepSIBA/article_results/article_data/all_compounds_go.rds"
pathway_scores <- readRDS(path_pa)
go_scores <- readRDS(path_gos)

dist_pb <- readRDS("C:/Users/user/Documents/deepSIBA/article_results/article_data/distributions_pb.rds")
dist_pt <- readRDS("C:/Users/user/Documents/deepSIBA/article_results/article_data/distributions_pt.rds")
dist_gb <- readRDS("C:/Users/user/Documents/deepSIBA/article_results/article_data/distributions_gb.rds")
dist_gt <- readRDS("C:/Users/user/Documents/deepSIBA/article_results/article_data/distributions_gt.rds")
...
mcf7 <- readRDS("C:/Users/user/Documents/deepSIBA/article_results/article_data/mcf7_all_sigs.rds")
...
for (n in 1:length(thresholds)) {
  ...
  query_val <- read.csv("C:/Users/user/Documents/deepSIBA/article_results/article_data/val_mcf7.csv")
  thresh <- d_th[1]
