...
min_sim <- 0.0
# extract split
cross_validation(dataframe = dataframe,allq1smiles = allq1smiles,ecfp_sims = ecfp_sims,no_folds = no_folds,n_drugs = n_drugs,max_sim = max_sim,
                 min_sim = min_sim,dir = dir)
